...
exports.init_ai = void 0;
const resource_1 = require("../../resource");
exports.init_ai = (0, resource_1.resource)({
    uri: "firebase://guides/init/ai",
    name: "ai_init_guide",
    title: "Firebase GenAI Init Guide",
    description: "guides the coding agent through configuring GenAI capabilities in the current project utilizing Firebase",
}, async (uri) => {
    return {
        contents: [
            {
